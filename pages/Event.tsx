...
const Event = () => {
  return (
    <section data-theme="dark" className="bg-primary text-text mt-20">
      ...
      <div className="grid grid-cols-1 md:gid-cols-2 lg:grid-cols-3 gap-5 md:p-medium">
        {/* Text for event photography */}
        <div className="flex flex-col gap-10 justify-center z-10 p-medium md:p-medium">
        ...
        <div className="md:col-span-2">
          <Image
            ...
            width={800}
            height={400}
            className="object-cover object-center w-full h-80 md:h-100"
          />
        </div>
        ...
        <div className="">
          <Image
            ...
            width={500}
            height={400}
            className="object-cover object-ccnter h-80 md:h-100"
          />
        </div>
        ...
        <div className="">
          <Image
            ...
            width={500}
            height={400}
            className="object-cover object-center h-80 md:h-100"
          />
        </div>

...
const SelectedWorks = () => {
  ...
  return (
    <section data-theme="dark" className="bg-neutral relative mt-20 h-[180vh] lg:h-[170vh] overflow-y-hidden">
      ...
      <h1 className="hidden absolute top-1/4 text-[3em] md:text-[7em] lg:text-[10em] w-full p-large uppercase font-extrabold text-center text-text leading-tight text-shadow-lg drop-shadow-2xl z-10">
        Selected <br /> works
      </h1>
      <Masonry
